...
Out of 100 top cryptocurriencies based on their market capitals (November, 2021), I have made three different groups based on the transaction proof types they use (made these groups based on proof type communality). It is possible to make three different groups of 22 out of 100 top cryptocurriencies.
These groups are
...
	Proof  Type- Delayed Proof of Stake(DPoS): Terra, Bittorrent, Tron, and Tezos.
...
These subgroups are
1.	Pos_1:  Algorand, Cosmos, Crypto.com, Cardano.
2.	Pos_2:  Near,  PayProtocol, and Oasis labs.
